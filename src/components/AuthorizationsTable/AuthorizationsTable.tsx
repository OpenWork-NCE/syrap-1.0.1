...
const useGetAuthorizations = () => {
	return useQuery<AuthorizationApiResponse>({
		...
		queryFn: () => fetch(innerUrl('/api/authorisations')).then((res) => res.json()),
	...
	return useMutation({
		mutationFn: async (authorization: Authorization) => {
			const response = await fetch(
				innerUrl("/api/authorisations/create"),
				{
					method: "POST",
					headers: {
...
function useUpdateAuthorization() {
	...
	return useMutation({
		mutationFn: async (authorization: Authorization) => {
			const response = await fetch(
				innerUrl(`/api/authorisations/${authorization.id}/update`),
				{
					method: "PUT",
					headers: {
						"Content-Type": "application/json",
...
function useDeleteAuthorization() {
	...
	return useMutation({
		mutationFn: async (authorizationId: string) => {
			const response = await fetch(
				innerUrl(`/api/authorisations/${authorizationId}/delete`),
				{
					method: "DELETE",
					headers: {
						"Content-Type": "application/json",
